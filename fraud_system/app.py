...
# Database path - use existing database
DATABASE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'api', 'fraud_detection.db')
...
def main():
    ...
    app = create_app()
    logger.info("=" * 50)
    logger.info("Real-Time Fraud Detection System v2.0.0")
    logger.info(f"Starting API on http://0.0.0.0:5000")
    logger.info("=" * 50)
